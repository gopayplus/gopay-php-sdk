...
use GopayPlus\Gopay\Enums\AccountType;
use GopayPlus\Gopay\Enums\DivisionRelationType;
...
final class Division extends HttpClient
{
     ...
     * @param \GopayPlus\Gopay\Enums\AccountType          $acc_type
     * @param string                                      $acc_no
     * @param string|null                                 $acc_name
     * @param \GopayPlus\Gopay\Enums\DivisionRelationType $relation_type
